...
import org.example.calculator.tobe.SubstractionOperator;

import java.util.List;

public class Calculator {

    private static final List<ArithmeticOperator> arithmeticOperators = List.of(new AdditionOperator(), new DivisionOperator(), new SubstractionOperator());
    /**
     * simple calculation.
     * Only positive Integer.
     * If divided by 0, will throw exception. MVC pattern
     */
